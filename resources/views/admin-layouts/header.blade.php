            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!--End Logo icon -->
                        <span class="hidden-xs font-bold">MyPerfect <span class="font-bold">BP</span></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="hidden-md-down">{{Sentinel::getUser()->first_name}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <form action="{{route('auth.logout')}}" class="ml-4" method="post" id="logout-form">
                                  {{ csrf_field() }}
